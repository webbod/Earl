      ...
      <div className="app-content">
        ...
        <div className="content">
          ...
          <div className="hero-tagline">
            <p>Royal Marine discipline. Proven results. Transformative fitness.</p>
          </div>
          <div className="spacer"></div>
          <div className="cta">
            ...
            <div className="content-grid">
              <div className="content-item">
                ...
                <div className="content-image">
                  <img src="https://picsum.photos/id/473/502/300" alt="Rehabilitation Training with Earl James in Coventry" />
                </div>
              </div>
            </div>
          </div>
